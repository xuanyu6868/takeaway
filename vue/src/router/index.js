...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'rider-orders', name: 'RiderOrders', meta: { name: '骑手订单信息' }, component: () => import('../views/manager/RiderOrders')},
      { path: 'riders', name: 'Rider', meta: { name: '骑手信息' }, component: () => import('../views/manager/Rider') },
    ]
  },
