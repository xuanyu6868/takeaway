...
<template>
	<view>
		...
		<swiper circular autoplay :interval="3000" :duration="500" indicator-dots style="height: 350rpx;"
			indicator-color="rgba(255, 255, 255, 0.6)" indicator-active-color="#8470FF">
		...
		<view style="padding: 20rpx;">
			...
			<!-- 商家列表 -->
			<view class="box" style="color: SlateBlue; font-size: 32rpx; font-weight: bold; margin-bottom: 10rpx;">
				热门商家
			</view>
				...
				<view class="box" v-for="item in businessList" :key="item.id"
					...
					<view style="flex: 1; display: flex; flex-direction: column; justify-content: space-between; grid-gap: 10rpx;">
						...
						<view style="display: flex;  color: #666; ">
							<view style="flex: 1;">
								<text style="color: #483D8B; font-weight: bold;">{{ item.score }}分</text>
						...
						<view style="color: #483D8B;">免配送费</view>
