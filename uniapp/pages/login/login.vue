<template>
  <view style="padding: 40rpx;">
    <view style="padding: 20rpx; margin: 80rpx 0; background-color: #fff; box-shadow: 0 10rpx 10rpx rgba(65,105,225,.1); border-radius: 40rpx;">
      ...
      <uni-forms ref="form" :modelValue="form" :rules="rules" validateTrigger='blur'>
        ...
        <uni-forms-item>
          <button @click="login()" style="background-color: #00BFFF; border-color: #00BFFF; height: 70rpx; line-height: 70rpx;">登   录</button>
        </uni-forms-item>
        <uni-forms-item>
        ...
        <uni-forms-item>
          <button @click="goToRiderLogin()" style="background-color: #FFA500; border-color: #FFA500; height: 70rpx; line-height: 70rpx; margin-top: 20rpx;">骑手端登录</button>
        </uni-forms-item>
      </uni-forms>
    </view>
  </view>
